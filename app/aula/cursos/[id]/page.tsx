  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {modulos.map((modulo) => (
          <Card key={modulo.mod_id_int} className="p-6 hover:border-accent transition-all duration-200 hover:shadow-lg overflow-hidden group">
            ...
            <div className="space-y-3">
              ...
              >
                <Button className="w-full bg-accent hover:bg-accent/90 text-primary font-semibold" size="sm">
                  Abrir módulo
                </Button>
              </Link>
            </div>
